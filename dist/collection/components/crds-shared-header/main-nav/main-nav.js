    ...
    */
    ...
    maybeRenderSubnavs(data) {
        ...
        return data.map(section => {
            ...
            return (h("nav-section-subnav", { subNavName: subNavName, handleBackClick: this.handleBackClick.bind(this), isActive: this.activeSection === subNavName },
    ...
    render() {
        if (!this.mainNavIsShowing || !Array.isArray(this.data))
            return null;
        return (h("nav", { class: this.navClasses(), onClick: event => event.stopPropagation() },
            h("div", { class: "content" },
                h("div", { class: "navigation" },
                    h("ul", null, this.maybeRenderSections(this.data))),
                h("div", { class: "subnavigation" }, this.maybeRenderSubnavs(this.data)),
